...
public class TCCART004 {
	...
	public void addToCart() throws InterruptedException {
		...
		List<WebElement> listOfCart = driver.findElements(By.xpath("/html/body/div[6]/div/div[1]/div/table/tbody/tr"));
		for(WebElement cart : listOfCart) {
			System.out.println(cart.getText());
			if(cart.equals("ASUS Full HD")) {
				cartCount++;
			}else {
				cartCount = cartCount;
			}
			...
			if(cartCount==0) {
				System.out.print("Product was deleted");
			}else {
				System.out.print("number of product : "+cartCount);
			}
		}
		...
		List<WebElement> listOfCart2 = driver.findElements(By.xpath("/html/body/div[6]/div/div[1]/div/table/tbody/tr"));
		for(WebElement cart : listOfCart2) {
			System.out.println(cart.getText());
			if(cart.equals("ASUS Full HD")) {
				cartCount++;
			}else {
