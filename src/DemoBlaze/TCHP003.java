...
public class TCHP003 {
	...
	@Test (priority = 3)
	public void phoneCategories() throws InterruptedException {
		driver.findElement(By.cssSelector(".list-group .list-group-item:nth-of-type(2)")).click();
		Thread.sleep(3000);
